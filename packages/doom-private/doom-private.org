...
#+end_src
#+RESULTS:
| +modeline-hide-in-non-status-buffer-h | modi/add-PR-fetch-ref | turn-on-magit-gitflow | doom--setq-evil-ex-hl-update-delay-for-magit-mode-h |
** Org Mode
*** Org Todo Keywords
...
;;              (insert-file-contents "/home/suwonp/h")
;;              (buffer-string))))
...
(after! vterm
  (setq vterm-tramp-shells '(("ssh" "/run/current-system/sw/bin/bash -l")
                             ("docker" "/bin/sh"))))

;; (after! vterm
;;   (setq vterm-tramp-shells '(("ssh" "~/.nix-profile/bin/bash --init-file <(echo \" . ~/.bash_profile\")")
;;                              ("docker" "/bin/sh"))))
